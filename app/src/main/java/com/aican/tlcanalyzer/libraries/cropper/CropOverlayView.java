...
package com.aican.tlcanalyzer.libraries.cropper;
    ...
    private void drawBackground(Canvas canvas) {
        ...
        if (mCropShape == CropImageView.CropShape.RECTANGLE) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                ...
                canvas.clipPath(mPath, Region.Op.XOR); //here i have changed
...
//                RectF ovalRect = new RectF(rect.left + oneThirdCropWidth, rect.top + oneThirdCropHeight,
//                        rect.right - oneThirdCropWidth, rect.bottom - oneThirdCropHeight);
//
//                // Draw oval guidelines
//                canvas.drawOval(ovalRect, mGuidelinePaint);
...
//            }
//
//            // Restrict vertical movement by setting top and bottom to their original positions
//            y = Math.max(rect.top, y); // Prevent moving up
//            y = Math.min(rect.bottom, y); // Prevent moving down
//
//            mMoveHandler.move(
//                    rect,
//                    x,
