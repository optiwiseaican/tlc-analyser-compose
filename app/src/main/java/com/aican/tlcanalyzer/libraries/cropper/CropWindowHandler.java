...
//    public float getMinCropWidth() {
//        if (Source.workingWithRectangleContour) {
//            Source.workingWithRectangleContour = false;
//            return Math.max(Source.WIDTH_OF_IMAGE, mMinCropResultWidth / mScaleFactorWidth);
//        } else {
//            return Math.max(mMinCropWindowWidth, mMinCropResultWidth / mScaleFactorWidth);
//        }
//    }
